...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    hp = models.IntegerField(verbose_name="담당자 핸드폰번호", null=True, unique=True)
    name = models.CharField(max_length=8, verbose_name="상호명", null=True)
    student_id = models.IntegerField(verbose_name="사업자등록번호", null=True)
    grade = models.CharField(choices=GRADE_CHOICES, max_length=18, verbose_name="사업유형", null=True)
    level = models.CharField(choices=LEVEL_CHOICES, max_length=18, verbose_name="등급", default=3)
    circles = models.CharField(choices=CIRCLES_CHOICES, max_length=18, verbose_name="연매출(기업가입)", null=True)
    department = models.CharField(choices=DEPARTMENT_CHOICES, max_length=24, verbose_name="연매출(일반가입)", null=True)
